        ...
        <div className={styles.page}>
            ...
            <div className={styles.content}>
                ...
                <p className={styles.firstParagraph}>
                    In this documentation you will find detailed descriptions of
                    the different setups we provide for each framework. You will
                    also find simple tutorials on how to get started building
