...
/* harmony export */   "q": () => (/* binding */ frameworkData)
/* harmony export */ });
const frameworkData = [
    {
        fullName: "ReactJs",
        ...
        available: true,
        description: "All the starter projects for ReactJs are based on the *Create-React-App template, and utilize the *CSS modules approach to styling components. The dependencies listed for the setups are ones that aren't also included in the blank setup",
        descriptionLinks: [
            {
        ...
        setups: [
            ...
            {
                fullName: "Simple @reduxjs/toolkit redux store with two state slices",
                description: {
    ...
    },
    {
        ...
        available: true,
        description: 'All the ExpressJs starter projects are based on the *ExpressJs "Hello World" example, but with *cors middleware added so as to allow front and back end to be on localhost, and *nodemon to restart the development server on every change made in any file.',
        descriptionLinks: [
            {
    ...
    },
    {
        ...
        description: "All the NextJs setups are based on the Create-Next-App setup, and all the dependencies listed are ones not already included in the blank project.",
        descriptionLinks: [
            {
        ...
        setups: [
            {
                fullName: "Blank NextJs app - slightly modified Create-Next-App setup",
                description: {
